...
This folder defines all source code for the 'pipeline3' pipeline:
...
* Take a look at the sample under "sample_users_pipeline3.py" to get familiar with the syntax.
